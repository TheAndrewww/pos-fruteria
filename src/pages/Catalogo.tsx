...
const defaultForm: FormData = {
  ...
  stock_actual: 0, es_temporada: false, activo: true,
};
...
// ──── Form Modal (componente separado para evitar re-mount) ────

function FormProducto({ editando, onClose, onSaved, onEliminar }: {
      ...
      <div className="card animate-fade-in" style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={{ background: 'var(--color-surface-2)', padding: 14, borderRadius: 10 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: esAdmin ? '1fr 1fr' : '1fr', gap: 10 }}>
              {esAdmin && (
                <div>
    ...
    <div className="page-module" style={{ gap: 8 }}>
            ...
            {lista.map(p => {
              ...
              return (
                <div key={p.id} className="card" style={{
                  ...
                  border: sinStock ? '2px solid var(--color-danger)' : '1px solid var(--color-border)',
                ...
                >
                  ...
                  <div style={{ padding: '10px 16px' }}>
                    {/* Precio */}
                    <div>
                      <div style={{ fontSize: 10, color: 'var(--color-text-dim)', fontWeight: 600 }}>PRECIO</div>
                    ...
                    <div style={{
                      ...
                      background: sinStock ? 'var(--color-danger-soft)' : 'var(--color-success-soft)',
                      display: 'flex', justifyContent: 'space-between', alignItems: 'center',
                    }}>
                      <span style={{ fontSize: 12, fontWeight: 600, color: sinStock ? 'var(--color-danger)' : 'var(--color-success)' }}>
      ...
      {showForm && (
        <FormProducto
          ...
          onSaved={async () => { await cargarTodo(); setShowForm(false); setEditando(null); }}
